...
import { Cpu, Layout, Database, Server, Wrench, Code2 } from "lucide-react";
...
const ORDERED_CATEGORIES: TechCategory[] = [
  "frontend",
  "backend",
  "database",
  "infrastructure",
        ...
        return (
          <motion.div
            ...
            className={cn(
              ...
              isFeatured
                ? "md:col-span-2 bg-gradient-to-br from-card/80 to-primary/5"
                : "",
            )}
          >
                      ...
                      >
                        {tech.icon_url && (
                          <img
                            src={tech.icon_url}
                            alt=""
                            className="h-3.5 w-3.5 opacity-60 grayscale hover:grayscale-0"
                          />
                        )}
                        {tech.name}
                      </span>
